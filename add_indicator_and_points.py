...
def main():
    ...
    root_dir = '/home/jovan/UNCC/10_aug_sp_cart_red_person_data/labels/train'
    json_file = root_dir + 'Ground_8605_scaled_labels.json'
    ...
    output_file_label = root_dir + 'Ground_8605_scaled_labels_ids_w_indicator.json'
    ## save to json
